...
def Buckling_Function(Pais,nEle,Inertiav,Inertiau,Inertiay,Inertiaz,Area,Comprimento_Barra,Sigma,Rigidez,nos_vento,Shape,Travamento,Top_bars,Middle_bars,ExpVento,Dim,Esp,TrussType,nos_montante,Conection_Ele,N_Bolt_Ele,GammaM1,F_Compressao,Size_Profile,Elements_Matrix,NTracRd,Troco):
    if Pais in ["Portugal","Portugal-RSA"]:
        ...
        Ratio_Enc,Enc_Out_csv,Enc_Out_Exp=Buckling_Function_Spain(nEle,Inertiav,Inertiau,Inertiay,Inertiaz,Area,Comprimento_Barra,Sigma,Rigidez,nos_vento,Shape,Travamento,Top_bars,Middle_bars,ExpVento,Dim,Esp,TrussType,nos_montante,Conection_Ele,N_Bolt_Ele,GammaM1,F_Compressao,Size_Profile,Elements_Matrix,NTracRd,Troco)
        return Ratio_Enc,Enc_Out_csv,Enc_Out_Exp   
    elif Pais in ["Italy"]:
        Ratio_Enc,Enc_Out_csv,Enc_Out_Exp=Buckling_Function_Italy(nEle,Inertiav,Inertiau,Inertiay,Inertiaz,Area,Comprimento_Barra,Sigma,Rigidez,nos_vento,Shape,Travamento,Top_bars,Middle_bars,ExpVento,Dim,Esp,TrussType,nos_montante,Conection_Ele,N_Bolt_Ele,GammaM1,F_Compressao,Size_Profile,Elements_Matrix,NTracRd,Troco)
        return Ratio_Enc,Enc_Out_csv,Enc_Out_Exp   
...
def Buckling_Function_Italy(nEle,Inertiav,Inertiau,Inertiay,Inertiaz,Area,Comprimento_Barra,Sigma,Rigidez,nos_vento,Shape,Travamento,Top_bars,Middle_bars,ExpVento,Dim,Esp,TrussType,nos_montante,Conection_Ele,N_Bolt_Ele,GammaM1,F_Compressao,Size_Profile,Elements_Matrix,NTracRd,Troco):
    Buckling_Curve=np.zeros(nEle+1).astype(str)
    Class_Enc=np.zeros(nEle+1)
    Check_Enc=np.zeros(nEle+1).astype(str)
    Comprimento_Enc=np.zeros(nEle+1)
