...
def Bolted_Connection_Bracing_France(Dig_Hor_Matrix,F_Tracao,F_Compressao,TrussType,Dim,GammaM2,ExpVento,Esp,Area,Leg_Type,Sigma_u,Sigma,GammaM0,Troco,nos_vento):    
...
def Bolted_Connection_Shaft_France(Shaft_Bolted_Matrix,TrussType,F_Tracao,F_Compressao,GammaM2,Sigma_u,Sigma,GammaM0,Area,Esp,Troco,nos_vento,divisor):
...
def Flanged_Bolted_Connection_France(Shaft_Flange_Matrix,TrussType,F_Tracao,Dim,Esp,Sigma_u,Sigma,GammaM2,GammaM0,Area,nos_vento,divisor):
...
def Flanged_Foundation_Angle_France(Flange_Foundation_Angle,Trusstype,F_tracao):
